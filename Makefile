...
# Uncomment to print various information.
# DEFINES += PRINT_CONV_PARAMS
# DEFINES += PRINT_CONV_TOTAL_CYCLE
DEFINES += PRINT_CONV_INNERMOST_CYCLE

export EXTRA_LITEX_ARGS="--cpu-variant=perf+cfu"
